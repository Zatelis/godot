...
// No need to define shadow data when using vertex lighting
// as it will be included in the scene_lights_inc.glsl
...
//TODO: probably need to not include lights in the fragment shader if vertex_lighting is used
